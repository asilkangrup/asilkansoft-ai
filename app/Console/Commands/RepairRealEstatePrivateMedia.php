...
{
    protected $signature = 'real-estate:repair-private-media {--limit=100}';

    protected $description = 'Re-download missing isolated Emlak AI media into durable private storage without AI analysis.';
