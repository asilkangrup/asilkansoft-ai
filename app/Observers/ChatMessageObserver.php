...
class ChatMessageObserver
{
    ...
    public function created(ChatMessage $message): void
    {
        ...
        // CRM-only production mode: never trigger vision/OCR from a model
        // observer. The original file is persisted by the isolated inbound
        // service and a lightweight delayed job only registers its gallery
        // category after the seller profile exists.
