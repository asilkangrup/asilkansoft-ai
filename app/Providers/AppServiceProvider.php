...
class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        // Shared CRM summary services use the global WAI OpenAI facade. Route
        // user 40 / bot 35 through explicit real-estate-aware wrappers so the
        // isolated tenant can never fall through to that global credential.
        $this->app->bind(
