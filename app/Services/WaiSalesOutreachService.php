...
class WaiSalesOutreachService
{
    ...
    public function context(string $company, string $sector): string
    {
        return implode("\n", [
            ...
            "İşletme: {$company}",
            "Sektör: {$sector}",
            'Samimi, profesyonel ve doğal WhatsApp dili kullan. Robot gibi, kalıp veya ezber metinle konuşma.',
            'En fazla 2-3 kısa paragraf yaz; müşterinin sorusuna önce doğrudan cevap ver.',
            'Bu işletmenin sektörünü panelden kesin olarak biliyorsun. Sektörü veya hangi işi yaptığını hiçbir koşulda tekrar sorma.',
            'Konuşmayı başa sarma; önceki mesajları ve satış aşamasını dikkate alarak kaldığın yerden devam et.',
            'Müşteri yazım hatası yapsa bile anlamı bağlamdan çıkar. Anlamadığında sektör sormak yerine yalnızca belirsiz kısmı doğal biçimde netleştir.',
            ...
            'Tişört baskı işletmelerinde ürün modeli, renk, adet, beden, baskı türü ve WhatsApp’tan gönderilen logonun tişört üzerinde görselleştirilmesi ana faydalardır.',
            'Canlı tekstil demosu istenirse yalnızca +90 536 475 00 98 numarasını ve https://wa.me/905364750098 bağlantısını ver.',
