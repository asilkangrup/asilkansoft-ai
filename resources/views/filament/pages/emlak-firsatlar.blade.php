...
.fo-grade{display:inline-flex;margin-top:9px;padding:6px 9px;border-radius:999px;background:#fff4dd;color:#875900;font-size:10px;font-weight:900}.fo-metrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px;margin-top:11px}.fo-metrics div{min-width:0;padding:9px;border-radius:11px;background:#f7faf8}.fo-metrics small{display:block;font-size:8px;font-weight:900;color:var(--muted)}.fo-metrics b{display:block;margin-top:3px;font-size:11px;color:#35463d}
