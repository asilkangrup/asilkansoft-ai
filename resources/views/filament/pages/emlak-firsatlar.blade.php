...
<style>
.fo{--ink:#122018;--muted:#718078;--line:#e4ebe7;max-width:1180px;margin:auto}.fo-hero{padding:24px;border:1px solid var(--line);border-radius:22px;background:linear-gradient(135deg,#fff,#fff8e8);margin-bottom:14px}.fo-hero small{color:#8a5a00;font-weight:900}.fo-hero h1{margin:6px 0;font-size:28px;font-weight:900;color:var(--ink)}.fo-hero p{margin:0;color:var(--muted);line-height:1.5}
...
.fo-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.fo-card{padding:18px;border:1px solid var(--line);border-radius:20px;background:#fff;box-shadow:0 9px 26px rgba(15,35,25,.035)}.fo-head{display:flex;justify-content:space-between;gap:10px}.fo-name{font-size:16px;font-weight:900;color:var(--ink)}.fo-property{margin-top:3px;font-size:12px;color:var(--muted)}.fo-score{width:56px;height:56px;display:grid;place-items:center;border-radius:50%;background:#122018;color:#fff;font-size:18px;font-weight:900}.fo-score.high{background:#087344}.fo-score.mid{background:#315b9c}.fo-score.blocked{background:#9a4141}
.fo-grade{display:inline-flex;margin-top:9px;padding:6px 9px;border-radius:999px;background:#fff4dd;color:#875900;font-size:10px;font-weight:900}.fo-metrics{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;margin-top:11px}.fo-metrics div{padding:9px;border-radius:11px;background:#f7faf8}.fo-metrics small{display:block;font-size:8px;font-weight:900;color:var(--muted)}.fo-metrics b{display:block;margin-top:3px;font-size:11px;color:#35463d}
.fo-deal{margin-top:10px;padding:12px;border-radius:13px;background:#fffaf0;border:1px solid #f2e3bd}.fo-deal-title{font-size:9px;font-weight:900;color:#8a5a00}.fo-deal-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;margin-top:8px}.fo-deal-grid small{display:block;font-size:8px;color:var(--muted);font-weight:900}.fo-deal-grid b{display:block;margin-top:3px;font-size:11px;color:var(--ink)}.fo-commercial-action{margin:8px 0 0;font-size:11px;line-height:1.45;color:#5f543d}.fo-commission{display:flex;gap:6px;align-items:center;margin-top:8px}.fo-commission input{width:95px;height:36px;padding:0 9px;border:1px solid var(--line);border-radius:9px;background:#fff}.fo-commission button{height:36px;padding:0 10px;border:0;border-radius:9px;background:#8a5a00;color:#fff;font-size:10px;font-weight:900}.fo-action{margin-top:10px;padding:12px;border-left:3px solid #22c77a;border-radius:10px;background:#f4fbf7}.fo-action small{font-size:9px;font-weight:900;color:#087344}.fo-action p{margin:4px 0 0;font-size:12px;line-height:1.5;color:#405149}.fo-foot{display:flex;justify-content:space-between;align-items:center;margin-top:11px}.fo-foot span{font-size:10px;color:var(--muted)}.fo-open{padding:8px 11px;border-radius:10px;background:#eef4ff;color:#315b9c;text-decoration:none;font-size:10px;font-weight:900}.fo-empty{grid-column:1/-1;padding:45px;text-align:center;border:1px dashed var(--line);border-radius:20px;color:var(--muted)}
@media(max-width:760px){.fo-deal-grid{grid-template-columns:1fr 1fr}.fo-commission input{font-size:16px}.fo-hero{padding:19px}.fo-hero h1{font-size:23px}.fo-stats{grid-template-columns:repeat(2,1fr)}.fo-tools{flex-direction:column}.fo-search{width:100%;font-size:16px}.fo-grid{grid-template-columns:1fr}.fo-card{padding:15px}}
</style>
<div class="fo">
    ...
    <div class="fo-stats">
        ...
        <div class="fo-stat"><b>{{ $this->stats['blocked'] }}</b><span>Risk nedeniyle blokeli</span></div>
    </div>
        ...
        @forelse($this->opportunities as $item)
            @php
                ...
                $gradeLabel = match($item['grade']) {
                    ...
                    'blocked'=>'RİSK BLOKESİ',default=>'DÜŞÜK ÖNCELİK',
                };
            @endphp
            <article class="fo-card" wire:key="opportunity-{{ $item['id'] }}">
                <div class="fo-head">
                    <div><div class="fo-name">{{ $item['name'] }}</div><div class="fo-property">{{ $item['property'] }}</div><span class="fo-grade">{{ $gradeLabel }}</span></div>
