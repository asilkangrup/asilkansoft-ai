...
.fi-sidebar,.fi-topbar,#wai-sidebar-toggle{display:none!important}.fi-main{margin-inline-start:0!important;padding:0!important;background:#07111f!important}.fi-main-ctn,.fi-page,.fi-body{padding:0!important;background:#07111f!important}.fi-page-header{display:none!important}
.ren-page{min-height:100vh;padding:20px;background:radial-gradient(circle at 8% 0,rgba(37,99,235,.18),transparent 28%),radial-gradient(circle at 94% 0,rgba(244,63,94,.1),transparent 24%),linear-gradient(180deg,#06101d,#081522 42%,#091522);color:#eef7ff}
.ren-kpi,.ren-panel{background:linear-gradient(145deg,#0d1a2a,#0a1624);border-color:#233448;box-shadow:0 14px 36px rgba(0,0,0,.14)}.ren-kpi small,.ren-head p,.ren-main span,.ren-empty{color:#8299ae}.ren-kpi strong,.ren-head h2,.ren-main b{color:#f8fbff}.ren-field label{color:#9db1c4}.ren-input{border-color:#304359;background:#081522;color:#f4f8fc}.ren-input:focus{border-color:#22c7e8;box-shadow:0 0 0 3px rgba(34,199,232,.1)}.ren-filter button,.ren-actions button{border-color:#304359;background:#081522;color:#a9bed1}.ren-filter button.active{border-color:#287c98;background:#11364c;color:#fff}.ren-table th{border-color:#26384b;background:#081522;color:#8299ae}.ren-table td{border-color:#1f2d3d;color:#cbd9e6}.ren-status{background:#203247;color:#c7d6e4}
@media(max-width:600px){.ren-page{padding:11px}}
</style>
@php($summary=$this->summary)
@php($rows=$this->rows)
<div class="ren-page">
@include('filament.partials.insurance-navigation', ['active' => 'renewal'])
